...
namespace NibrsXml.Builder
{
    class IncidentBuilder
    {
        public static Incident Build(LIBRSAdmin admin)
        {
            ...
            inc.ActivityDate = new ActivityDate(ExtractNibrsIncidentDateTime(admin));
        ...
        /// </summary>
        private static string ExtractNibrsIncidentDateTime(LIBRSAdmin admin)
        {
            ...
            return String.Format("{0}-{1}-{2}T{3}:00:00", year, month, day, hour == String.Empty ? "00" : hour);
        }
